# Node.js Interview Questions 中文翻译
...
![v8-overview](assets/v8-overview-2.png)
...
3. **Angular.js** - 用于网络应用的 JavaScript MVC 框架
4. **Node.js** - 用于可扩展的服务器端和网络应用的框架。
...
![Key-Features-of-NodeJs.png](assets/Key-Features-of-NodeJs.png)
...
它是一段泛型代码，在几个异步函数调用之间运行，被称为控制流函数。
...
**什么时候不使用 Node.js(When to not use Node.js)**
...
![Node.js-Advantages](assets/Node.js-Advantages.jpg)
![Node.js-Disadvantages](assets/Node.js-Disadvantages.jpg)
...
![express-mw-cn](assets/express-mw-cn.png)
